...
if starting_weights == 0:
	...
	actor_critic.actor_model.load_weights("./ddpg_ca_models/iteration" + str(starting_weights))
	actor_critic.critic_model.load_weights("./ddpg_ca_models/critic/critic" + str(starting_weights))
	actor_critic.target_actor_model.load_weights("./ddpg_ca_models/target_actor/target_actor" + str(starting_weights))
	actor_critic.target_critic_model.load_weights("./ddpg_ca_models/target_critic/target_critic" + str(starting_weights))
...
for i in range(num_trials):
	...
	if (i % 100 == 0 and i > 1):
		actor_critic.actor_model.save_weights("./ddpg_ca_models/iteration" + str(i + starting_weights))
		actor_critic.critic_model.save_weights("./ddpg_ca_models/critic/critic" + str(i + starting_weights))
		actor_critic.target_actor_model.save_weights("./ddpg_ca_models/target_actor/target_actor" + str(i + starting_weights))
		actor_critic.target_critic_model.save_weights("./ddpg_ca_models/target_critic/target_critic" + str(i + starting_weights))
